...
Works across AVR, ESP32, and other Arduino-compatible platforms as well as with standard C++, making it possible to do the demanding training on a computer and import the trained model to Arduino afterwards.


## Dependency

The neuralNetwork.hpp library uses LightweighSTL library (https://github.com/BojanJurca/Lightweight-Standard-Template-Library-STL-for-Arduino) to assure compatibility with standard C++.
